...
class CreateDataset():
    def __init__(self, csv_path='D:\\HETHONGSLCT\\Spelling_Correction_Vietnamese\\data\\samples_sentence.csv', save_path="D:\\HETHONGSLCT\\Spelling_Correction_Vietnamese\\data\\list_ngrams.npy"):
